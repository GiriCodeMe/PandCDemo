...
| Employee notifications | Open | Life event and open enrollment notification hooks are referenced in REQ-OE-013, REQ-LE-011, REQ-DEP-004, REQ-TERM-008. No in-app notification rendering spec yet. Channel (email, in-app, webhook) and template format unspecified. |
| Dependent SSN validation | Open | Demo scenario seeded (CT-10045: Linda White, DEP-INVALID SSN). No explicit validation rule yet defined as a named requirement. |
